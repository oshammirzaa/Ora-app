...
//#region node_modules/.nitro/vite/services/ssr/assets/login-DYh85Rqs.js
...
function AdvisorLogin() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AuthFrame, {
		...
		subtitle: "Desk, incoming chats, and payouts. Separate from the customer account.",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SocialSignIn, { callbackURL: "/advisor" }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						className: "w-full",
						disabled: busy,
						children: busy ? "Signing in…" : "Sign in to desk"
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						...
						children: "Apply and create an account"
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
...
//#endregion
export { AdvisorLogin as component };
