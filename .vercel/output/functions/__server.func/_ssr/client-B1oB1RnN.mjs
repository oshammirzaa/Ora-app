...
import { Bt as isSafeUrlScheme, Ht as capitalizeFirstLetter, Ut as toKebabCase, zt as createFetch } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/client-B1oB1RnN.js
var client_B1oB1RnN_exports = /* @__PURE__ */ __exportAll({
	i: () => signOut,
	n: () => client_exports,
	r: () => signIn,
	t: () => authClient
...
async function signOut(redirectTo = "/") {
	try {
		const { forgetMe } = await import("./client-cache-eGj0Q9iR.mjs").then((n) => n.r).then((n) => n.r);
		forgetMe();
	} catch {}
	await runSignOut({
		livePreview: inLivePreview(),
...
//#endregion
export { signOut as i, client_B1oB1RnN_exports as n, signIn as r, authClient as t };
